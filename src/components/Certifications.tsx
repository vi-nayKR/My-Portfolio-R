                    ...
                    <div className="w-8 h-8 rounded-lg bg-accent/10 flex items-center justify-center shrink-0">
                      {cert.icon === 'linkedin' ? (
                        ...
                        <svg className="w-4 h-4 text-accent" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147L12 14.283l7.74-4.136L12 6.011 4.26 10.147zm0 0a1.994 1.994 0 01-1.07-1.916V6.9a2 2 0 011.666-1.972l5.807-1.161a2 2 0 011.666 0l5.808 1.161A2 2 0 0119.8 6.9v1.33a1.994 1.994 0 01-1.07 1.917M12 14.283v6.331m-3-1.636l3 1.636 3-1.636"/>
                        </svg>
                      )}
                    </div>
