...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col items-center justify-start md:justify-center overflow-hidden px-4 md:px-6 pt-36 pb-12 md:pt-40 md:pb-24"
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center justify-start md:justify-between gap-8 md:gap-12 flex-none md:flex-1">
